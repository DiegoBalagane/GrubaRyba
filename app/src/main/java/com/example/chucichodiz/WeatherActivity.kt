...
class WeatherActivity : AppCompatActivity() {
    ...
    val API: String = "df5302dbb86e9e23c9d1906e691bd0ae"
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        actionBar!!.title = "Pogoda" // changing title of activity
   ...
   /* inner class weatherTask() : AsyncTask<String, Void, String>() {
        ...
        override fun onPostExecute(result: String?) {
            try {
                ...
                val updatedAtText = "Updated at: "+ SimpleDateFormat("dd/MM/yyyy hh:mm", Locale.GERMAN).format(Date(updatedAt*1000))
                val temp = main.getString("temp")+"°C"
                val tempMin = "Min Temp: " + main.getString("temp_min")+"°C"
                val tempMax = "Maks Temp: " + main.getString("temp_max")+"°C"
